        ...
        <div class="onboarding-main">
            <form class="onboarding-pane formPersonal">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="the_person_first_name" class="form-control" placeholder="Your first name here" />
                </div>
                <div class="input-group">
            ...
            <form class="onboarding-pane formAddress">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <label for="the_person_first_name">Address</label>
                        <input type="text" name="the_person_address" class="form-control" placeholder="000" required />
                    </div>
                    <div class="col-sm-4">
                        <label for="the_person_last_name">Postal Code</label>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <label for="the_person_last_name">Province, State, County</label>
                        <input type="text" name="the_person_county" class="form-control" placeholder="Your last name here" required />
                    </div>
                    <div class="col-sm-4">
                        <label for="the_person_last_name">City</label>
                        <input type="text" name="the_person_city" class="form-control" placeholder="Your last name here" required />
                    </div>
                </div>
