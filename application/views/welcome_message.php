...
<head>
	...
	<title>Prycely</title>
	<!-- Bootstrap CSS -->
	<link rel="stylesheet" href="https://prycely.com/assets/frontend/css/bootstrap.min.css">
	<link rel="stylesheet" href="https://prycely.com/assets/frontend/vendors/bootstrap-selector/css/bootstrap-select.min.css">
	<!--icon font css-->
	<link rel="stylesheet" href="https://prycely.com/assets/frontend/vendors/themify-icon/themify-icons.css">
	<link rel="stylesheet" href="https://prycely.com/assets/frontend/vendors/flaticon/flaticon.css">
	<link rel="stylesheet" href="https://prycely.com/assets/frontend/vendors/animation/animate.css">
	<link rel="stylesheet" href="https://prycely.com/assets/frontend/vendors/owl-carousel/assets/owl.carousel.min.css">
	<link rel="stylesheet" href="https://prycely.com/assets/frontend/vendors/magnify-pop/magnific-popup.css">
	<link rel="stylesheet" href="https://prycely.com/assets/frontend/vendors/nice-select/nice-select.css">
	<link rel="stylesheet" href="https://prycely.com/assets/frontend/vendors/elagent/style.css">
	<link rel="stylesheet" href="https://prycely.com/assets/frontend/css/style.css">
	<link rel="stylesheet" href="https://prycely.com/assets/frontend/css/responsive.css">
</head>
...
<body>
	...
	<div class="body_wrapper">
		<header class="header_area">
			<nav class="navbar navbar-expand-lg menu_one menu_four">
				<div class="container">
					<a class="navbar-brand sticky_logo" href="#"><img src="https://prycely.com/assets/images/logo.png" srcset="https://prycely.com/assets/images/logo.png" alt="logo" style="width: 70px;"><img src="https://prycely.com/assets/images/logo.png" srcset="img/logo2x.png 2x" alt="" style="width: 70px;"></a>
		...
		<section class="payment_banner_area">
			...
			<div class="animation_img_two wow fadeInRight" data-wow-delay="0.5s">
				<img src="https://prycely.com/assets/frontend/img/home9/mac.png" alt="">
			</div>
			<img class=" svg_intro_bottom" src="https://prycely.com/assets/frontend/img/home9/shape.png" alt="">
		</section>
				...
				<div class="row featured_item">
					<div class="col-lg-6">
						<div class="payment_featured_img wow fadeInLeft" data-wow-delay="0.2s">
							<img src="https://prycely.com/assets/frontend/img/home9/featured_img.png" alt="">
						</div>
					</div>
					<div class="col-lg-6 d-flex align-items-center">
						<div class="payment_features_content pl_70 wow fadeInRight" data-wow-delay="0.3s">
							<div class="icon">
								<img class="img_shape" src="https://prycely.com/assets/frontend/img/home9/icon_shape.png" alt="">
								<img class="icon_img" src="https://prycely.com/assets/frontend/img/home9/icon1.png" alt="">
							</div>
				...
				<div class="row flex-row-reverse featured_item">
					<div class="col-lg-6">
						<div class="payment_featured_img img_two wow fadeInRight" data-wow-delay="0.3s">
							<img src="https://prycely.com/assets/frontend/img/home9/featured_img_two.png" alt="">
						</div>
					</div>
					<div class="col-lg-6 d-flex align-items-center">
						<div class="payment_features_content pr_70 wow fadeInLeft" data-wow-delay="0.4s">
							<div class="icon">
								<img class="img_shape" src="https://prycely.com/assets/frontend/img/home9/icon_shape.png" alt="">
								<img class="icon_img" src="https://prycely.com/assets/frontend/img/home9/icon2.png" alt="">
							</div>
							<h2>Quick & Easy Process</h2>
							<p>Cras mush pardon you knees up he lost his bottle it's all gone to pot faff about porkies arse, barney argy-bargy cracking goal loo cheers spend.!</p>
					...
					<div class="col-lg-4">
						<div class="service-content wow fadeInRight" data-wow-delay="0.2s">
							<div class="pay_icon">
								...
								<img src="https://prycely.com/assets/frontend/img/home9/icon3.png" alt="">
							</div>
					...
					<div class="col-lg-8">
						<div class="row">
							<div class="col-md-6 media payment_service_item wow fadeInUp" data-wow-delay="0.2s">
								<div class="icon">
									<img src="https://prycely.com/assets/frontend/img/home9/icon4.png" alt="">
								</div>
							...
							<div class="col-md-6 media payment_service_item wow fadeInUp" data-wow-delay="0.3s">
								<div class="icon">
									<img src="https://prycely.com/assets/frontend/img/home9/icon7.png" alt="">
								</div>
								<div class="media-body">
							...
							<div class="col-md-6 media payment_service_item wow fadeInUp" data-wow-delay="0.4s">
								<div class="icon">
									<img src="https://prycely.com/assets/frontend/img/home9/icon5.png" alt="">
								</div>
								<div class="media-body">
							...
							<div class="col-md-6 media payment_service_item wow fadeInUp" data-wow-delay="0.5s">
								<div class="icon">
									<img src="https://prycely.com/assets/frontend/img/home9/icon8.png" alt="">
								</div>
								<div class="media-body">
							...
							<div class="col-md-6 media payment_service_item wow fadeInUp" data-wow-delay="0.6s">
								<div class="icon">
									<img src="https://prycely.com/assets/frontend/img/home9/icon6.png" alt="">
								</div>
								<div class="media-body">
					...
					<div class="col-lg-6">
						<div class="payment_clients_inner">
							<div class="clients_item one wow fadeInLeft" data-wow-delay="0.2s">
								<img src="https://prycely.com/assets/frontend/img/home9/logo1.png" alt="">
							</div>
							<div class="clients_item two wow fadeInLeft" data-wow-delay="0.3s">
								<img src="https://prycely.com/assets/frontend/img/home9/logo2.png" alt="">
							</div>
							<div class="clients_item three wow fadeInLeft" data-wow-delay="0.4s">
								<img src="https://prycely.com/assets/frontend/img/home9/logo3.png" alt="">
							</div>
							<div class="clients_item four wow fadeInLeft" data-wow-delay="0.5s">
								<img src="https://prycely.com/assets/frontend/img/home9/logo4.png" alt="">
							</div>
							<div class="clients_item five wow fadeInLeft" data-wow-delay="0.6s">
								<img src="https://prycely.com/assets/frontend/img/home9/logo5.png" alt="">
							</div>
							<div class="clients_item six wow fadeInLeft" data-wow-delay="0.7s">
								<img src="https://prycely.com/assets/frontend/img/home9/logo6.png" alt="">
							</div>
							<div class="clients_item seven wow fadeInLeft" data-wow-delay="0.8s">
								<img src="https://prycely.com/assets/frontend/img/home9/logo7.png" alt="">
							</div>
							<div class="clients_item eight wow fadeInLeft" data-wow-delay="0.8s">
								<img src="https://prycely.com/assets/frontend/img/home9/logo8.png" alt="">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row payment_testimonial_info flex-row-reverse">
					...
					<div class="col-lg-5">
						<div class="testimonial_img">
							<img src="https://prycely.com/assets/frontend/img/home9/testimonial_img.png" alt="">
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						<div class="col-lg-5 col-md-6">
							<div class="f_widget company_widget pr_100">
								<a href="index.html" class="f-logo"><img src="https://prycely.com/assets/images/logo.png" srcset="https://prycely.com/assets/images/logo.png" alt="logo" style="width: 70px;"></a>
	...
	<script src="https://prycely.com/assets/frontend/js/jquery-3.2.1.min.js"></script>
	<script src="https://prycely.com/assets/frontend/js/propper.js"></script>
	<script src="https://prycely.com/assets/frontend/js/bootstrap.min.js"></script>
	<script src="https://prycely.com/assets/frontend/vendors/wow/wow.min.js"></script>
	<script src="https://prycely.com/assets/frontend/vendors/sckroller/jquery.parallax-scroll.js"></script>
	<script src="https://prycely.com/assets/frontend/vendors/owl-carousel/owl.carousel.min.js"></script>
	<script src="https://prycely.com/assets/frontend/vendors/imagesloaded/imagesloaded.pkgd.min.js"></script>
	<script src="https://prycely.com/assets/frontend/vendors/isotope/isotope-min.js"></script>
	<script src="https://prycely.com/assets/frontend/vendors/magnify-pop/jquery.magnific-popup.min.js"></script>
	<script src="https://prycely.com/assets/frontend/vendors/bootstrap-selector/js/bootstrap-select.min.js"></script>
	<script src="https://prycely.com/assets/frontend/vendors/nice-select/jquery.nice-select.min.js"></script>
	<script src="https://prycely.com/assets/frontend/js/plugins.js"></script>
	<script src="https://prycely.com/assets/frontend/js/main.js"></script>
</body>
