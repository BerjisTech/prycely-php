<div class="row">
    ...
    <div class="col-sm-4 hidden-xs right-card switch-card chat-card">
        ...
        <div class="input-group">
            <span class="input-group-addon entypo-cancel btn-danger" onclick="$(this).parent().parent().addClass('hidden-xs');$('.switch-tab[data-hide=\'switch-transactions\']').trigger('click');"></span>
