<div class="row">
    <div class="col-sm-8">
        ...
        <div class="row row-tabs">
            <div class="col-4 text-center"><span>Transactions</span></div>
            <div class="col-4 text-center"><span>Stats</span></div>
            <div class="col-4 text-center"><span>Wallets</span></div>
        </div>
